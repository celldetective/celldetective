...
* **Integration of state-of-the-art solutions** : Celldetective harnesses state-of-the-art segmentation techniques (**StarDist** [#]_, **Cellpose** [#]_ , [#]_) as well as threshold-based segmentation, and tracking algorithms (**bTrack** [#]_, **trackpy**), along with the napari viewer [#]_ with custom plugins to correct masks and tracks. These algorithms are interfaced to be well integrated and accessible for the target audience, in the context of complex biological applications.
