...
def compute_survival(
    ...
    cut_observation_time : float or None, optional
            A cutoff time to artificially reduce the observation window and exclude late events. If None, uses all available data (default is None).
    pairs : bool, optional
            Whether the data represents pairs of cells. If True, grouping is done by 'REFERENCE_ID' and 'NEIGHBOR_ID'. Default is False.
    Returns
    -------
    ...
    events, survival_times = switch_to_events(
        ...
        event_times,
        max_times,
        origin_times=first_detections,
        left_censored=left_censored,
        FrameToMin=FrameToMin,
