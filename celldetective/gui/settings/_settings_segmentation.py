...
class SettingsSegmentation(CelldetectiveSettingsPanel):
    ...
    def _create_widgets(self):
        ...
        self.flip_segmentation_checkbox: QCheckBox = QCheckBox(
            "Segment frames in reverse order"
        )
        self.flip_segmentation_checkbox.setIcon(
            icon(MDI6.camera_flip_outline, color="black")
        )
        ...
        self.flip_segmentation_checkbox.setToolTip(
    ...
    def _load_previous_instructions(self):
        """Load previous instructions from JSON file."""
