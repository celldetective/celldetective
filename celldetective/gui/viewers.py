...
import gc
from scipy.ndimage import shift, map_coordinates, distance_transform_edt
...
class CellEdgeVisualizer(StackVisualizer):
    ...
    def compute_edge_labels(self):
        ...
        # Use unified utility
        from celldetective.utils import contour_of_instance_segmentation
...
class ChannelOffsetViewer(StackVisualizer):
    ...
    def generate_overlay_imshow(self):
        self.im_overlay = self.ax.imshow(
            ...
            cmap="Blues",
            interpolation="none",
            alpha=self.overlay_alpha_slider.value(),
            **self.imshow_kwargs,
        )
